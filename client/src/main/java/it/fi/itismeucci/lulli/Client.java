...
public class Client {
        ...
        do {
            ...
            switch (opzioneDestinatario) {
                ...
                case "2":
                    ...
                    do {
                        menuPriv();
                        option = tastiera.readLine();
                        switch (option) {
                            case "0":
                                System.out.println("Uscito dalla chat privata");
                                break;
                            ...
                            case "2":
                                System.out.println("Reinserire il destinatario: ");
    ...
    public static void threadRecvMessage() throws IOException {
        ...
        // lista degli utenti connessi
            ...
            System.out.println(mexRicevuto.getText());
            System.out.println("Inserire il destinatario: ");
        }
        // chiusura client
    ...
    public static void menuPriv() throws IOException {
        System.out.println("");
        System.out.println("               Menu-Chat");
        System.out.println(" 0 -> Uscire dalla chat privata"
                + '\n'
                + " 1 -> Scrivere il messaggio"
                + '\n'
                + " 2 -> Reinserire il destinatario");
        System.out.println("");
        System.out.print("Seleziona l'opzione: ");
    }
}
